...
namespace directed_local_planner {
  void DirectedLocalPlanner::reconfigure(DirectedLocalPlannerConfig &config)
  {
  ...
  DirectedLocalPlanner::DirectedLocalPlanner(std::string name, base_local_planner::LocalPlannerUtil *planner_util) :
      ...
      alignment_costs_(planner_util->getCostmap())
  {
    ...
    ROS_INFO("Testsdasdasdasdasdasdasdqweasdasd");
    ...
    map_viz_.initialize(name, planner_util->getGlobalFrame(), boost::bind(&DirectedLocalPlanner::getCellCosts, this, _1, _2, _3, _4, _5, _6));
  ...
  bool DirectedLocalPlanner::getCellCosts(int cx, int cy, float &path_cost, float &goal_cost, float &occ_cost, float &total_cost) {
  ...
  bool DirectedLocalPlanner::setPlan(const std::vector<geometry_msgs::PoseStamped>& orig_global_plan) {
    oscillation_costs_.resetOscillationFlags();
   ...
   */
  bool DirectedLocalPlanner::checkTrajectory(
      Eigen::Vector3f pos,
      Eigen::Vector3f vel,
  ...
  void DirectedLocalPlanner::updatePlanAndLocalCosts(
   ...
   */
  base_local_planner::Trajectory DirectedLocalPlanner::findBestPath(
      const geometry_msgs::PoseStamped& global_pose,
