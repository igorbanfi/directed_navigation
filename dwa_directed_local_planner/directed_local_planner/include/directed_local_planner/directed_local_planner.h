#ifndef DIRECTED_LOCAL_PLANNER_DIRECTED_LOCAL_PLANNER_H_
#define DIRECTED_LOCAL_PLANNER_DIRECTED_LOCAL_PLANNER_H_
...
namespace directed_local_planner {
  /**
   * @class DirectedLocalPlanner
   * @brief A class implementing a directed local planner using the Dynamic Window Approach
   */
  class DirectedLocalPlanner {
    public:
      /**
       ...
       */
      DirectedLocalPlanner(std::string name, base_local_planner::LocalPlannerUtil *planner_util);

      /**
       * @brief Reconfigures the trajectory planner
       */
      void reconfigure(DirectedLocalPlannerConfig &cfg);
    ...
    private:
      ...
      directed_layer::DirectedLayer* directed_layer_;
  };
};
#endif
